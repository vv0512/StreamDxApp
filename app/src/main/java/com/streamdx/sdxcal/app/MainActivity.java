...
public class MainActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final Intent intent = new Intent(this, RealTimeGraphing.class);
        intent.putExtra(RealTimeGraphing.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(RealTimeGraphing.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        if (mScanning) {
